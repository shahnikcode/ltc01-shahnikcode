...
**Nikita**: I had to create a remote branch because in between tries to work on the rmarkdown file my github kept logging out.  I made sure that my branches were merged, knitted, staged, commited, pulled, then commited a message, then pushed to get this to my shahnikcode-patch-1 file.  I also realized that I incorrectly created a repository so I went back and created a new repository in my github and then tried pushing these items again. I also needed to push my readme file again.  I had some issues with merging but I think I resolved them.
